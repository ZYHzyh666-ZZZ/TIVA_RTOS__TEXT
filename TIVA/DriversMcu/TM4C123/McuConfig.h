...
#define	UART1_RX			GPIO_PB0_U1RX
#define	UART1_TX			GPIO_PB1_U1TX
#define	UART1_PORT			GPIOB_BASE
#define	UART1_PIN_RX		GPIO_PIN_0
#define	UART1_PIN_TX		GPIO_PIN_1
...
#define	UART3_RX			GPIO_PC6_U3RX
#define	UART3_TX			GPIO_PC7_U3TX
#define	UART3_PORT			GPIOC_BASE
#define	UART3_PIN_RX		GPIO_PIN_6
#define	UART3_PIN_TX		GPIO_PIN_7
...
#define	UART6_RX			GPIO_PD4_U6RX
#define	UART6_TX			GPIO_PD5_U6TX
#define	UART6_PORT			GPIOD_BASE
#define	UART6_PIN_RX		GPIO_PIN_4
#define	UART6_PIN_TX		GPIO_PIN_5
