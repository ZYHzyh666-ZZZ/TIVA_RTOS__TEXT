...
static inline void RC_Data_Task(float dT_s)
{
	...
	if ( rc_in.fail_safe == 0)
	{
        ...
        /*AUX4 一键锁桨*/
		if(rc_in.rc_ch.st_data.ch_[ch_8_aux4] < 1200)//解锁
		{
//			if(LOCK == 1)
//			{
//				ANO_DT_SendString(Str_RED,"NOT LOCK!");
////				if(rc_in.rc_ch.st_data.ch_[ch_9_aux5] > 1700)//条件特殊(按住按键一进行解锁才满足）
////				{
////					ANO_DT_SendString(Str_RED,"NOT LOCK! two");//解锁即怠速
////					Onekey_Unlock();
////				}	
//				
//			}
        ...
        else if(rc_in.rc_ch.st_data.ch_[ch_8_aux4] > 1700)//锁浆
		{
			Onekey_lock();
		}
		//有切换模式时执行
